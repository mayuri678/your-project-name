...
export const routes: Routes = [
  ...
  { path: 'login-debug', loadComponent: () => import('./login-debug.component').then(m => m.LoginDebugComponent) },
  { path: 'logout-test', loadComponent: () => import('./logout-test.component').then(m => m.LogoutTestComponent) },
