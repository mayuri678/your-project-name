...
@Component({
  selector: 'app-forgot-password-magic',
  standalone: true,
  ...
  template: `
    <div class="forgot-password-container">
      <div class="forgot-password-card">
        ...
        <form (ngSubmit)="sendOTP()" *ngIf="!emailSent">
...
export class ForgotPasswordMagicComponent {
  email: string = '';
  ...
  async sendOTP(): Promise<void> {
    ...
    try {
      const { error } = await this.supabaseAuth.supabase.auth.resetPasswordForEmail(this.email, {
        redirectTo: `${window.location.origin}/change-password-reset`
      });
